...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference("Notice.count") do
      post notices_url, params: { notice: { cuerpo: @notice.cuerpo, encabezado: @notice.encabezado, link: @notice.link, tipo: @notice.tipo } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { cuerpo: @notice.cuerpo, encabezado: @notice.encabezado, link: @notice.link, tipo: @notice.tipo } }
